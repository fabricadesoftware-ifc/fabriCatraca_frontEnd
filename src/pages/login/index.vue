...
<template>
  <v-app style="background: #131313;">
    ...
    <v-app-bar flat color="transparent" class="px-2">
      <v-app-bar-title>
        <span class="text-h6 font-weight-bold" style=" letter-spacing: 0.1em;">
          FabriCatraca
        </span>
      </v-app-bar-title>
      <template #append>
    ...
    <!-- Footer -->
    <v-footer color="transparent" class="justify-center" height="10">
      <span
        class="text-caption font-weight-medium"
        style="color: rgba(193,198,215,0.4);"
      >
